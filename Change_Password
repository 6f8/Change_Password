...
def login():
    ...
    new_password = input('\033[1;97m[\033[\033[31;1m+\033[1;97m] Enter Your New Password : '+E)
...
def change():
    ...
    head2 = {
            ...
            'origin':'https://www.instagram.com',#exec
...
if __name__ == '__main__':
    ...
    file = input('\033[1;97m[\033[\033[31;1m+\033[1;97m] Enter File Users ( \033[31;1mUser:Pass\033[1;97m ) : '+E)
    if '.txt' in file:
        pass
    else:#@vnvn6
        files  = file + '.txt'
